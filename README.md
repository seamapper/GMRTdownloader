...
│
├── media/
│   ├── GMRT-logo2020.png       # Icon source (edit this, then run convert_icon.py)
│   ├── GMRT-logo2020.ico       # Windows / in-app window icon
│   ├── GMRT-logo2020.icns      # macOS app bundle icon
│   └── convert_icon.py         # Regenerates .ico and .icns from .png
│
├── README.md                   # This file
